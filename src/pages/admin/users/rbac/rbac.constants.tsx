...
export const ALL_PERMISSIONS = [
  ...
  { id: 'user:read', resource: 'user', label: 'Xem người dùng', desc: 'Tra cứu thông tin tài khoản học viên/người giảng dạy' },
  ...
  { id: 'notif:manage', resource: 'notif', label: 'Quản lý thông báo', desc: 'Tạo và gửi thông báo cho học viên/người giảng dạy' },
