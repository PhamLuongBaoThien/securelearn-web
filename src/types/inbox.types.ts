...
export interface Ticket { _id: string; type: TicketType; title: string; description: string; sender: TicketSnapshot; target?: TicketTarget | null; status: TicketStatus; lastActivityAt: string; lastMessageAt: string; lastPublicMessageAt: string; unread: boolean; createdAt: string; updatedAt: string }
