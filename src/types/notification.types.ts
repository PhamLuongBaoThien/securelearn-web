...
export type NotificationEvent = 'WELCOME' | 'PAYMENT_SUCCESS' | 'PAYMENT_FAILED' | 'COURSE_APPROVED' | 'COURSE_REJECTED' | 'COURSE_SUBMITTED_FOR_REVIEW' | 'ENROLLMENT_CREATED' | 'MANUAL';
