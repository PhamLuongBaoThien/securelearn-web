...
export type NotificationEvent = 'WELCOME' | 'PAYMENT_SUCCESS' | 'PAYMENT_FAILED' | 'COURSE_APPROVED' | 'COURSE_REJECTED' | 'COURSE_SUBMITTED_FOR_REVIEW' | 'ENROLLMENT_CREATED' | 'REPORT_CREATED' | 'SUPPORT_REQUEST_CREATED' | 'FEEDBACK_CREATED' | 'INBOX_USER_REPLIED' | 'INBOX_ADMIN_REPLIED' | 'INBOX_STATUS_CHANGED' | 'INBOX_ASSIGNED' | 'MANUAL';
