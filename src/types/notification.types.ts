...
export type NotificationEvent = 'WELCOME' | 'PAYMENT_SUCCESS' | 'PAYMENT_FAILED' | 'COURSE_APPROVED' | 'COURSE_REJECTED' | 'COURSE_SUBMITTED_FOR_REVIEW' | 'COURSE_SUBSCRIPTION_APPROVED' | 'COURSE_SUBSCRIPTION_REJECTED' | 'COURSE_SUBSCRIPTION_REMOVED' | 'ENROLLMENT_CREATED' | 'DISCUSSION_CREATED' | 'DISCUSSION_REPLIED' | 'COURSE_ANNOUNCEMENT_PUBLISHED' | 'REPORT_CREATED' | 'SUPPORT_REQUEST_CREATED' | 'FEEDBACK_CREATED' | 'INBOX_USER_REPLIED' | 'INBOX_ADMIN_REPLIED' | 'INBOX_STATUS_CHANGED' | 'MANUAL';
