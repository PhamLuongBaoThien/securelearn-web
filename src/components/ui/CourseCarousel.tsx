...
export const CourseCarousel = ({ courses }: { courses: ICourse[] }) => {
  ...
  return (
    <div className="relative group/carousel">
      <button 
        onClick={scrollLeft}
        className="absolute left-0 top-1/3 -translate-y-1/2 -translate-x-4 z-20 w-12 h-12 bg-background border border-border shadow-md rounded-full flex items-center justify-center opacity-0 group-hover/carousel:opacity-100 transition-opacity hover:bg-secondary focus:opacity-100 disabled:opacity-0"
      >
      ...
      <button 
        onClick={scrollRight}
        className="absolute right-0 top-1/3 -translate-y-1/2 translate-x-4 z-20 w-12 h-12 bg-background border border-border shadow-md rounded-full flex items-center justify-center opacity-0 group-hover/carousel:opacity-100 transition-opacity hover:bg-secondary focus:opacity-100 disabled:opacity-0"
      >
